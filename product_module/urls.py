...
urlpatterns = [
    ...
    path('category/<str:category_url>', ProductsListView.as_view(), name='products_by_category_page'),
    path('brand/<str:brand_url>', ProductsListView.as_view(), name='products_by_brand_page'),
