...
class Order(models.Model):
    ...
    status = models.CharField(
        max_length=150, choices=status_choices, default=status_choices.CART
    )
...
class DiscountCode(models.Model):
    ...
    max_uses = models.PositiveIntegerField(
        null=True, blank=True, verbose_name="حداکثر تعداد کل استفاده"
    )
    updated_at = models.DateTimeField(auto_now=True, verbose_name="آخرین آپدیت")
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="تاریخ ایجاد")
    is_active = models.BooleanField(
...
class UserDiscountUsage(models.Model):
    ...
    status_usage = models.CharField(
        max_length=150, choices=status_choices, default=status_choices.NOT_USED
    )
