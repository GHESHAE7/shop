...
class ContactUs(models.Model):
    ...
    email = models.CharField(
        max_length=255, null=False, blank=False, verbose_name="ایمیل"
    )
    subject = models.CharField(
        max_length=255, null=False, blank=False, verbose_name="موصوغ"
    )
...
class SubjectContact(models.Model):
    name = models.CharField(
        max_length=100, null=False, blank=False, verbose_name="نام موضوع"
    )
    description = models.CharField(
        max_length=500, null=True, blank=True, verbose_name="توصیحاتی در باره موضوع"
    )
    updated_at = models.DateTimeField(auto_now=True, verbose_name="آخرین آپدیت")
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="تاریخ ایجاد")
    is_active = models.BooleanField(
